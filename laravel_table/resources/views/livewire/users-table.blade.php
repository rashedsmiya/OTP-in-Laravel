                        ...
                        <tbody>
                            ...
                            <tr wire:key='{{ $user->id }}' class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button onclick="confirm('Are you sure want to delete {{ $user->name }} ?') || event.stopImmediatePropagation()" wire:click='delete({{ $user->id }})' class="px-3 py-1 bg-red-500 text-white rounded">X</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
